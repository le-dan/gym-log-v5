	...
	return (
		<div className="flex flex-col w-full gap-10 px-5">
			<div className="w-full flex justify-center">
				<div className="rainbow-box font-bold text-5xl w-1/7 desktop:w-1/5 md:text-2xl text-center text-snow-white p-0.5 shadow-md shadow-primary rounded-lg">
			...
			<div className="flex items-center gap-10">
				<div className="basis-1/3 shrink-0 flex items-center gap-8 justify-start">
					...
					<div className="desktop:text-7xl text-2xl text-primary font-bold">
				...
				<div className="h-full text-2xl desktop:text-7xl text-primary font-bold flex justify-end items-center gap-4 shrink-0 basis-1/3">
					<span className="flex items-center justify-center text-4xl desktop:text-8xl inset-shadow-sm rounded-lg p-1 px-3 inset-shadow-primary/50">
						{remainingExercises}
					</span>
					exercises
				</div>
