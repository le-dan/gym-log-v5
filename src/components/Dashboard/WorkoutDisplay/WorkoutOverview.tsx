		...
		<div className="flex flex-col w-full gap-10 px-5 desktop:px-80">
			<div className="w-full flex justify-center">
				<div
					...
					} rainbow-box font-bold text-5xl w-fit md:text-2xl text-center text-snow-white p-0.5 shadow-md shadow-primary rounded-lg`}
				>
			...
			<div className="flex items-center gap-10 w-full">
				<div className="basis-1/3 shrink-0 flex items-center gap-8 justify-start">
					<div className="flex gap-3">
						<CircleArrowLeft
							size={matches ? 50 : 40}
							className="hover-css text-red-400 hover:text-accent"
						...
						{stopwatch.isRunning ? (
							<>
								<CirclePause
									size={matches ? 50 : 40}
									className="hover-css hover:text-yellow-400 text-yellow-500"
							...
							<>
								<CirclePlay
									size={matches ? 50 : 40}
									className="hover-css hover:text-green-400 text-green-500"
					...
					<div
						className={`desktop:text-6xl text-2xl text-primary font-bold ${
							!stopwatch.isRunning ? "opacity-30 select-none pointer-events-none" : ""
						}`}
					>
				...
				<div
					className={`${
						!stopwatch.isRunning ? "opacity-30 select-none pointer-events-none" : ""
					} flex gap-3 rounded-lg shadow-md bg-snow-white  w-1/4 desktop:w-full p-2 items-center justify-center grow`}
				>
				...
				<div
					className={`${
						!stopwatch.isRunning ? "opacity-30 select-none pointer-events-none" : ""
					} h-full text-2xl desktop:text-5xl text-primary font-bold flex justify-end items-center gap-4 shrink-0 basis-1/3`}
				>
